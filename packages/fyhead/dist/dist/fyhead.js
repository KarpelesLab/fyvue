...
var vue = require("vue"), pinia = require("pinia");
...
const __fyHeadCount__ = "fyhead:count", useFyheadState = pinia.defineStore("fyHeadState", () => {
  const head = vue.ref({
    links: {},
    metas: {},
    scripts: {},
...
exports.createFyHead = createFyHead, exports.useFyHead = useFyHead;
