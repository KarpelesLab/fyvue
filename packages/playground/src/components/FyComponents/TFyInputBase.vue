...
<template>
  ...
  <FyInput
    ...
    :req="true"
    :showLabel="true"
    :placeholder="$t('test-error_placeholder')"
    :label="$t('test-error_label')"
    type="text"
  ...
  <FyInput
    v-model="state.testSelect"
    id="testSelect"
    :options="selectOptions"
    :showLabel="true"
    :placeholder="$t('test_select')"
    :label="$t('test_select_label')"
    type="select"
  />

  <FyInput
    v-model="state.testUsername"
    id="test_username"
    :req="true"
    :showLabel="true"
  ...
  <FyInput
    v-model="state.testTextarea"
    id="test_textarea"
    :req="true"
    :showLabel="true"
    :placeholder="$t('test_textarea_label')"
    :label="$t('test_textarea_placeholder')"
    type="textarea"
  />
  <FyInput
    v-model:checkboxValue="state.testCheckbox"
    id="checkbox"
    :req="true"
    :showLabel="true"
