...
const _hoisted_13$4 = createElementVNode("br", null, null, -1);
                    ...
                    ? (openBlock(), createElementBlock("div", {
                        ...
                        createElementVNode("div", _hoisted_1$5, [
                            createElementVNode("div", _hoisted_2$5, [
                                (__props.displayOnly)
                                    ? (openBlock(), createElementBlock("label", _hoisted_3$5, toDisplayString(_ctx.$t('klb_user_location_label')), 1))
                                    : createCommentVNode("v-if", true),
                    ...
                    createVNode(script$n, {
                        ...
                        default: withCtx(() => [
                            ...
                            createElementVNode("form", {
                                ...
                                (errorMessage.value)
                                    ? (openBlock(), createElementBlock("div", _hoisted_11$4, toDisplayString(errorMessage.value), 1))
                                    : createCommentVNode("v-if", true),
...
const _hoisted_11$3 = createElementVNode("br", null, null, -1);
                ...
                (unref(isAuth) && isLoaded.value)
                    ? (openBlock(), createElementBlock("div", _hoisted_1$3, [
                        ...
                        createElementVNode("div", _hoisted_2$3, [
                            (!billingEmpty.value)
                                ? (openBlock(), createBlock(_component_FyInput, {
                                    key: 0,
                            ...
                            (editMode.value == false && !billingEmpty.value)
                                ...
                                }, toDisplayString(_ctx.$t('klb_edit_billing_profile')), 1))
                                : createCommentVNode("v-if", true),
                            ...
                            (editMode.value == true)
                                ...
                                }, toDisplayString(_ctx.$t('klb_billing_cancel_save_payment_method')), 1))
                                : createCommentVNode("v-if", true),
                            (editMode.value == false)
                                ? (openBlock(), createElementBlock("button", {
                                    key: 3,
                                ...
                                }, toDisplayString(_ctx.$t('klb_add_new_billing_profile')), 1))
                                : createCommentVNode("v-if", true)
                        ]),
                        (editMode.value)
                                ...
                                createElementVNode("div", null, [
                                    createElementVNode("form", {
                                        ...
                                        createElementVNode("div", _hoisted_5$3, [
                                            ...
                                            createElementVNode("div", _hoisted_9$3, toDisplayString(_ctx.$t('klb_billing_credit_card_edit_help')), 1)
                                        ]),
                                        ...
                                        (unref(v$).billingProfile.location.$errors.length > 0)
                                            ? (openBlock(), createElementBlock("div", _hoisted_10$3, toDisplayString(_ctx.$t(`vuelidate_validator_${unref(v$).billingProfile.location.$errors[0].$validator.toString()}`)), 1))
                                            : createCommentVNode("v-if", true),
                                        _hoisted_11$3,
                            ...
                            return (openBlock(), createElementBlock("div", {
                                ...
                                createElementVNode("div", null, [
                                    ...
                                    createElementVNode("div", _hoisted_3$2, [
                                        createElementVNode("span", _hoisted_4$2, toDisplayString(product.Price.display), 1),
                                        (product['Basic.ServiceLifetime'])
                                            ? (openBlock(), createElementBlock("span", _hoisted_5$2, "/" + toDisplayString(_ctx.$formatKlbRecurringPaymentCycle(product['Basic.ServiceLifetime'])), 1))
                                            : createCommentVNode("v-if", true)
                                    ]),
                                    (product.Image &&
                                        product.Image.list &&
                                ...
                                createElementVNode("div", _hoisted_11$2, [
                                    ...
                                    createElementVNode("div", _hoisted_12$1, [
                                        createElementVNode("span", null, [
                                            ...
                                            (product['Basic.ServiceLifetime'])
                                                ? (openBlock(), createElementBlock("span", _hoisted_13$1, "/" + toDisplayString(_ctx.$formatKlbRecurringPaymentCycle(product['Basic.ServiceLifetime'])), 1))
                                                : createCommentVNode("v-if", true)
                                        ]),
                                        createElementVNode("button", {
                                            class: "btn primary btn-defaults",
    ...
    setup(__props) {
        ...
        return (_ctx, _cache) => {
            ...
            return (openBlock(), createElementBlock("div", _hoisted_1$1, [
                createVNode(script$f, { id: "klb-order" }),
                (process.value)
                    ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                        createElementVNode("form", {
        ...
        return (_ctx, _cache) => {
            ...
            return (isReady.value)
                ? (openBlock(), createElementBlock("div", _hoisted_1, [
                    createVNode(script$f, { id: "klb-order-main" }),
