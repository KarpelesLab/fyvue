...
import { FyHeadLazy } from '@fy/head';
...
declare function handleSSR(createApp: Function, cb: Function, options?: SSROptions): Promise<KlbSSR>;
...
declare function restFetch<ResultType extends FetchResult>(url: string, method?: string, params?: object): Promise<ResultType>;
...
declare const useSeo: (seo: Ref<FyHeadLazy>, initial?: boolean) => void;
